...
- [Higress MCP Server Hosting](https://github.com/alibaba/higress/tree/main/plugins/wasm-go/mcp-servers) - A solution for hosting MCP Servers by extending the API Gateway with wasm plugins.
